# -*- coding: utf-8 -*-
"""
Django settings for devtinder project.
...
LOCAL_APPS = (
    # custom users app
    'devtinder.users.apps.UsersConfig',
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'devtinder.contrib.sites.migrations'
}
...
ADMINS = (
    ("""Vasco Pinho & Andre Silva""", 'you@example.com'),
)
...
LOGIN_REDIRECT_URL = 'users:add-snippet'
